...
@Test
public void testBuffMessage() throws IOException {
	  assertEquals("Hello Harrison!",RnW.BuffFile(file));
	}
...
public void testPrintMessage() throws IOException {
	 assertEquals("Changed!",RnW.PrintFile(file,"Changed!"));
}

@Test
public void testOutputMessage() throws IOException {
	 assertEquals("Changed!",RnW.OutputFile(file,"Changed!"));
}

@Test
public void testWriteMessage() throws IOException {
	 assertEquals("Changed!",RnW.WriteFile(file,"Changed!"));
}
